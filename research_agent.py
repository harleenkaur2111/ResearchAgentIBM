params = {
    "space_id": "56493013-794d-46f2-9850-3e1c16b945c9", 
}
...
def gen_ai_service(context, params = params, **custom):
    ...
    def create_custom_tools():
        ...
        name_Academic_Literature_Search_g8ic5 = "Academic Literature Search"
        desc_Academic_Literature_Search_g8ic5 = """Helps the agent find relevant academic papers by searching research-focused websites like arXiv, ResearchGate, and PubMed based on the user’s topic query."""
        code_Academic_Literature_Search_g8ic5 = """def main(**params):\n    query = params.get("query", "")\n    if not query:\n        return {"error": "Query is missing."}\n\n    search_links = [\n        f"https://arxiv.org/search/?query={query.replace(' ', '+')}&searchtype=all",\n        f"https://scholar.google.com/scholar?q={query.replace(' ', '+')}",\n        f"https://www.ncbi.nlm.nih.gov/pmc/?term={query.replace(' ', '+')}"\n    ]\n\n    return {\n        "papers": search_links,\n        "note": "These are links to academic search results. Open them in a browser to explore relevant papers."\n    }\n"""
        params_Academic_Literature_Search_g8ic5 = {
        }
    
        schema_Academic_Literature_Search_g8ic5 = {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Research topic to perform literature survey on"
                }
            }
        }
        custom_tools.append(create_custom_tool(name_Academic_Literature_Search_g8ic5, desc_Academic_Literature_Search_g8ic5, code_Academic_Literature_Search_g8ic5, schema_Academic_Literature_Search_g8ic5, params_Academic_Literature_Search_g8ic5))
...
You are a highly trained AI research assistant. Your job is to help students and researchers with:
- Summarizing academic topics
- Identifying research gaps
- Suggesting related questions
- Providing citations in IEEE format (if asked)
Be concise, structured and accurate. Always respond in an academic tone and support answers with examples when needed."""
